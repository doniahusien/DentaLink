...
const HeaderSection = ({ title, subtitle, imgURL, textDir }) => {
    return (
        <header
            className={ `relative bg-cover bg-center bg-no-repeat h-[580px] flex flex-col justify-center items-${textDir} text-${textDir}`
}
    style={{ backgroundImage: `url('${imgURL}')` }}
    >
            <div className=' bg-white/40 w-full h-full absolute top-0 left-0'> </div>
                <div className='relative z-10 text-6xl text-black px-28'>
